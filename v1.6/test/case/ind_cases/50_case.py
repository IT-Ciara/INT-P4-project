...
def main():
    ...
    key = stg_8_ig_tbl.make_key([gc.KeyTuple("ig_intr_md.ingress_port", ports_data['ingress_port'])])
    ...
    for port, config in ports_config.items():
        ...
        if eg_user_port==1:
            ...
            egress_user_port_tbl(eg_user_port_tbl,dev_tgt,eth_type,u_vid,u_mask,s_vid,s_mask,eg_action,new_vid=0,new_vid_actions=new_vid_actions)
