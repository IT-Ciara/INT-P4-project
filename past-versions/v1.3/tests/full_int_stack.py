...
int_shim_layer = CustomINTShim(int_count=6, next_hdr=0x8100)
...
int_layer_5 = CustomINT(data=0x06)
...
pkt = ethernet_layer / s_vlan_layer / int_shim_layer / int_layer_0 / int_layer_1 / int_layer_2 / int_layer_3 / int_layer_4 / int_layer_5 / u_vlan_layer / ip_layer / udp_layer / payload_layer

pkt.show()

#Save the packet to a pcap file
wrpcap("./pcaps/full_int_stack.pcap", pkt)
