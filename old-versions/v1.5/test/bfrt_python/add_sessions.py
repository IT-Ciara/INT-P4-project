...
def create_entries():
    ...
    unicast_session(session=5,port=13)
    multicast_session(session=10, ports=[13, 14])
    multicast_session(session=15,ports=[13,15])
    multicast_session(session=20, ports=[13, 16])
    multicast_session(session=25, ports=[13,14, 15])
    multicast_session(session=30, ports=[13, 14,15, 16])

    unicast_session(session=35, port=14)
    multicast_session(session=40, ports=[14, 15])
    multicast_session(session=45, ports=[14, 16])
    multicast_session(session=50, ports=[14, 15, 16])

    unicast_session(session=55, port=15)
    multicast_session(session=60, ports=[15, 16])

    unicast_session(session=65, port=16)
