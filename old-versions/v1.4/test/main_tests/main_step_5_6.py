...
from entries_generator import entries_step_5_6
from stats_tracker import tracker_step_5_6
from scapy_pkts import pkts_step_5_6
width = 120
RED = "\033[91m"
GREEN = "\033[92m"
BLUE = "\033[94m"
...
def add_entries():
    ...
    . ../tools/set_sde.bash
    ./run_bfshell.sh -b ~/code/v1.4/test/entries_generator/entries_step_5_6.py
    """
    try:
...
def track_stats_and_send_packets():
    tracker_step_5_6.main()
    pkts_step_5_6.create_send_pkt(["veth0"])
    time.sleep(2)
    tracker_step_5_6.main()
...
def main():
    ...
    print(f"{BLUE}{'='*width}{RESET}")
    print(f"{BLUE}{' S T E P   5   A N D   6  T E S T S'.center(width)}{RESET}")
    print(f"{BLUE}{'='*width}{RESET}")
    print(f"{BLUE}{'='*width}{RESET}")
