...
def create_entries():
    ...
    INGRESS_NO_VLAN_TRAFFIC_TABLE.add_with_forward(ingress_port=8, egress_port=9)

    INGRESS_VLAN_TRAFFIC_TABLE.add_with_forward(vid=1000, vid_mask=0xFF, ingress_port=8, ether_type=0x88a8, MATCH_PRIORITY=20, egress_port=9)
